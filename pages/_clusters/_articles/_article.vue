      ...
      <header class="section-post">
        <div class="post_header">
          <div class="post_background">
                ...
                <div class="padding-vertical padding-xhuge">
                  <div class="post_title-wrapper">
                    ...
                    <div class="margin-bottom margin-large">
                      <h1 class="heading-xlarge text-color-white">
                        {{ article.title }}
                      </h1>
                    </div>
                    <!--Post Info-->
            ...
            <div class="post_pattern-left"></div>
          </div>
        </div>
        <div class="page-padding">
          <div class="container-small is-blog">
              ...
              <div class="post_component">
                <div class="post_content-top">
                  ...
                  <div class="post_breadcrumb hide-mobile-portrait">
                    ...
                    >
                      <div>Back to {{ cluster.name }} Calculator</div>
                    </nuxt-link>
                  ...
                  <div class="w-layout-grid post_share content-top">
                    <a href="#" class="post_social-link w-inline-block">
                      <div class="post_social-icon w-embed">
                        <svg
                          width="24"
                          height="24"
                          viewbox="0 0 24 24"
                ...
                <div class="post_content-bottom">
                  <div class="margin-bottom margin-large">
                    <div class="post_share-wrapper">
                      <div class="text-size-medium text-weight-semibold">
                        Share this post
                      </div>
                      <div class="w-layout-grid post_share">
                        <a href="#" class="post_social-link w-inline-block">
                          <div class="post_social-icon w-embed">
                            <svg
                              width="24"
              ...
              <div class="cta_component">
                <div class="margin-bottom margin-small">
                  <h2 class="heading-large">
                    Have you Tried Our {{ cluster.name }} Calculator?
                  </h2>
                </div>
...
export default {
  ...
  head() {
    return {
      title: this.article.seoTitle ? this.article.seoTitle : this.article.title,
      meta: [
        {
          hid: "description",
          name: "description",
